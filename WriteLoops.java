...
public class WriteLoops {
    ...
    public void simpleLoops() {
        ...
        // do while loop will iterate at least once even if the condition is 
        //false where while will not iterate if the condition is false
